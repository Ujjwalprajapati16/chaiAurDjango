...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('chai', '0002_chaivariety_description_chaivariety_price_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='chaivariety',
            name='type',
            field=models.CharField(choices=[('GR', 'GINGER'), ('ML', 'MASALA'), ('BL', 'BLACK'), ('CH', 'CHAI LATTE'), ('HD', 'HERBAL DECAF'), ('MT', 'MATCHA'), ('GR', 'GREEN'), ('WH', 'WHITE'), ('OL', 'OOLONG')], max_length=2),
        ),
